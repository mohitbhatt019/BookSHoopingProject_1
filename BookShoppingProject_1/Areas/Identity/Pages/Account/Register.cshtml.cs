...
namespace BookShoppingProject_1.Areas.Identity.Pages.Account
{
    ...
    public class RegisterModel : PageModel
    {
        ...
        private readonly UserManager<IdentityUser> _userManager;    //for malking user
        ...
        public RegisterModel(
            ...
            UserManager<IdentityUser> userManager,    //to create user
            SignInManager<IdentityUser> signInManager,   //for login
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                var user = new ApplicationUser()
                {
                    ...
                    Role=Input.Role
                };                                                   //it will start creating user now
